...
title = Label(root, text='Welcome to Face Recognition System', fg='black',bg='white',font=('bold',17))
...
credits = Label(root,bg='black',fg='white',text='©Developed by Akshat Shah',height=3,width=120)
